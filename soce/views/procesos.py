...
def procesos_view():
    return rx.vstack(
        ...
        rx.table.root(
            rx.table.header(rx.table.row(rx.table.column_header_cell("ID"), rx.table.column_header_cell("Código"), rx.table.column_header_cell("Fecha"), rx.table.column_header_cell("Acciones"))),
