...
def proceso_detalle_view():
    return rx.vstack(
        ...
        rx.card(rx.hstack(
            rx.button(rx.cond(ProcesosState.is_scraping, rx.spinner(size="1"), "Iniciar Barrido"), 
                      on_click=ProcesosState.iniciar_scraping, disabled=ProcesosState.is_scraping), 
