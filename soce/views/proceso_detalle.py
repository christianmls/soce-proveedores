...
def oferta_card(ruc: str):
    # Calculamos la suma total de las ofertas de este proveedor para mostrar el Total de Proforma
    return rx.card(
        rx.vstack(
            ...
            # Mostramos los anexos capturados
            rx.vstack(
                ...
                rx.flex(
                    rx.foreach(
                        ...
                        lambda a: rx.cond(
                            a.ruc_proveedor == ruc,
                            rx.link(
                                rx.badge(rx.icon("file-down", size=14), a.nombre_archivo, color_scheme="blue"),
                                href=a.url_archivo, is_external=True
                            )
                        )
                    ),
                    wrap="wrap", spacing="2"
